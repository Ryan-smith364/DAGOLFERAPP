...
Review.create(user: user4, course: course2, review_text: " Pace was slow, experience could've been better ", rating: 3)
Review.create(user: user5, course: course6, review_text: " Amazing Staff", rating: 5)
Review.create(user: user3, course: course3, review_text: " meh ", rating: 2)
Review.create(user: user1, course: course4, review_text: " I played good here ", rating: 4)
Review.create(user: user7, course: course5, review_text: " Best course ive been to", rating: 5)